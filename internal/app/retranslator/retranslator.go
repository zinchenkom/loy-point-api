...
import (
	...
	"github.com/zinchenkom/loy-point-api/internal/app/consumer"
	"github.com/zinchenkom/loy-point-api/internal/app/producer"
...
func NewRetranslator(cfg Config) Retranslator {
	events := make(chan loyalty.PointEvent, cfg.ChannelSize)

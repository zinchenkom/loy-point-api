...
// Source: github.com/zinchenkom/loy-point-api/internal/app/repo (interfaces: EventRepo)
...
func (m *MockEventRepo) Add(arg0 []loyalty.PointEvent) error {
	m.ctrl.T.Helper()
...
func (m *MockEventRepo) Lock(arg0 uint64) ([]loyalty.PointEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lock", arg0)
	ret0, _ := ret[0].([]loyalty.PointEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
